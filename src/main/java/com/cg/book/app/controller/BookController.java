...
/**********************************************************************************/	
//	@GetMapping("/get-all-books-by-name/{name}")
//	public ResponseEntity<Books> getAllBooksByName(@PathVariable("name") String name) {
//		Books books = bookservice.getAllBooksByName(name);
//		if (books == null) {
//			return ResponseEntity.status(HttpStatus.NOT_FOUND).build();
//		}
